...
public class Board {
    ...
    public void addRandomTile() {
        ...
        int r = openSpaces.get(x).getRow();
        int c = openSpaces.get(x).getCol();
     ...
     * (ex: 0 4 0 4 becomes 4 4 0 0). gameBoard[row][col] = 0
     **/
        ...
        for ( int r = 0; r < gameBoard.length; r++ ) {
            for ( int c = 1; c < gameBoard[r].length; c++ ) {
                if (gameBoard[r][c] != 0){
                    int count = c-1;
                    int index = c;
                    while ((count >=0)&&(gameBoard[r][count]==0)){
                        if (gameBoard[r][count] == 0){
                            gameBoard[r][count] = gameBoard[r][index];
                            gameBoard[r][index] = 0;
                            count-=1;
                            index-=1;
                        }
    ...
    public void transpose() {
        ...
        for ( int r = 0; r < gameBoard.length; r++ ) {
            for ( int c = 0; c < gameBoard[r].length; c++ ){
                newBoard[c][r]=gameBoard[r][c];
            }
        }
        for ( int r = 0; r < gameBoard.length; r++ ) {
            for ( int c = 0; c < gameBoard[r].length; c++ ){
                gameBoard[r][c]=newBoard[r][c];
            }
        }
    }
